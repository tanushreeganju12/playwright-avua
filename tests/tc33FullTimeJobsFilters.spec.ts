 ...
 */
async function pollForMagicLink(recipientEmail: string, maxAttempts = 20): Promise<string> {
...
test('TC33 - Logged in applicant filters full-time jobs by date, preference, and work model', async ({ page }) => {
  ...
  const resumePath = `./fixtures/resume_tc33_${count}.pdf`;
  ...
  try {
    ...
    // Step 10: Navigate to Full-time Jobs board (All Opportunities)
    console.log('Navigating to Full-time Jobs board...');
    ...
    // Step 11: Apply "Last week" Date Posted filter and refine
    ...
    // Step 12: Apply "Full time" Job Preference filter and refine
    ...
    // Step 13: Apply "Part time" Job Preference filter and refine
    ...
    // Step 14: Apply "Remote" Employment Model filter and refine
    ...
    // Step 15: Apply "Hybrid" Employment Model filter and refine
    ...
    // Step 16: Apply "On-site" Employment Model filter and refine
    ...
    // Step 17: Apply "Last month" Date Posted filter and refine
    ...
    await page.screenshot({ path: 'screenshots/tc33_full_time_jobs_filters.png', fullPage: true });
    console.log('TC33 successfully completed and verified!');

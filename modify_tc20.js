...
// The last test is TC13 Successful submission with minimum 3 years experience
const lastTestStart = "test('TC13 Successful submission with minimum 3 years experience'";

const newTC20 = `  test('TC20 Successful submission with UNDECIDED ENGAGEMENT model', async ({ page }) => {
...
content = content.replace(lastTestStart, newTC20 + "\n\n  " + lastTestStart);

fs.writeFileSync('tests/employerJobPost.spec.ts', content);
console.log('Successfully updated tests/employerJobPost.spec.ts with TC20');
